...
using BotAPI.Application.Features.Products.Commands.UpdateProduct;
using BotAPI.Application.Wrappers;
using BotAPI.Domain.Products.DTOs;
using BotAPI.FunctionalTests.Common;
using Shouldly;

namespace BotAPI.FunctionalTests.ApiEndpoints
{
